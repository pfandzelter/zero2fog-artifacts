...
// prepare csv
const filename = "results-applicationpath-cfd.csv";
fs.writeFileSync(filename, "camera_type,wgw_type,fctry_datacenter_type,office_datacenter_type,cloud_type,prod_cntrl_type,cfd_map,proc_time,proc_cost,tx_time,tx_cost,full_time,full_cost,existsCoherentFlow\n");
...
infrastructureOptions.forEach((infrastructure, i) => {
  ...
  // i hate js
  let thismodel = JSON.parse(JSON.stringify(require("./model-cfd.json")));
